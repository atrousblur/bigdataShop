...
public class ProductCommentDTO {
	...
	public int getPrdcmt_no() {
		return prdcmt_no;
	}

	public void setPrdcmt_no(int prdcmt_no) {
	...
	public ProductCommentDTO(int prdcmt_no, String prd_no, String mem_id, String pro_comment, Date writedate) {
		super();
		this.prdcmt_no = prdcmt_no;
		this.prd_no = prd_no;
		this.mem_id = mem_id;
